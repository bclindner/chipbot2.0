...
class KarmaManager {
  ...
  /**
   * Check if a subject can be downvoted.
   * @param {string} subject - The subject to downvote.
   * @return {boolean} Whether or not the subject can be downvoted.
   */
  canDownvote (subject) {
    return this.db
  ...
  /**
   * Check if a subject can be upvoted.
   * @param {string} subject - The subject to upvote.
   * @return {boolean} Whether or not the subject can be upvoted.
   */
  canUpvote (subject) {
    return this.db
      .find({'subject': subject})
